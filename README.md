...
- **Структурированный контент** — 10+ страниц по трём разделам: подбор, обслуживание, документы
...
| **Стилизация** | CSS (кастомная тёмная и светлая темы) |
...
│ ├── custom.css # Стилизация (тёмная и светлая темы)
